...
required_contracts = ["/api/studio/plan", "/api/studio/status", "/api/studio/manifest", "/api/studio/run", "/api/studio/runs/{run_id}", "/api/studio/runs/{run_id}/advance", "/api/studio/runs/{run_id}/manifest", "/api/studio/runs/{run_id}/artifacts/{artifact_name}", "/api/studio/runs/{run_id}/music-task", "StudioPlanRequest", "StudioPlanResponse"]
